...
export default function Resume() {
  ...
  useEffect(() => {
    // Now the navbar won't appear repeatedly
    setIsMounted(true);
  }, []);
              ...
              <div className="scroll-inner">
                <div className="intro">
                  ...
                  <span className="quote">
                    <span>
                      Creating web applications that are functional, efficient,
                      and impactful.
                    </span>
                    <span>
                      I&apos;m a Full Stack Developer, learning advanced MERN
                      stack, including React, Redux, Express, MongoDB, Jest with
                      a sprinkle of Next.js and TypeScript.
                    </span>
                  </span>
                  <Link
                        ...
                        <div key={i} className="items-inner">
                          ...
                          <div className="item-arrow-container">
                            <svg
                              ...
                              height="16"
                              fill="currentColor"
                              className="bi bi-arrow-up-right item-arrow"
                              viewBox="0 0 16 16"
                            >
                              <path
                                fillRule="evenodd"
                  ...
                  <div className="content">
                    <div className="content-inner">
                      <svg
                        ...
                        height="16"
                        fill="currentColor"
                        className="bi bi-mortarboard-fill logo"
                        viewBox="0 0 16 16"
                      >
                      ...
                      <div className="items" key={i3}>
                        <div className="items-inner">
                          <svg
                            ...
                            height="16"
                            fill="currentColor"
                            className="bi bi-patch-check-fill logo"
                            viewBox="0 0 16 16"
                          >
                      ...
                      <div className="items" key={i3}>
                        <div className="items-inner">
                          <svg
                            ...
                            height="16"
                            fill="currentColor"
                            className="bi bi-flag-fill logo"
                            viewBox="0 0 16 16"
                          >
